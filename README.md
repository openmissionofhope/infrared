...
At its core, Infrared transforms raw activity into a **Warmth Index**.  
This index reflects the presence or absence of “life” in a system or community.

### Signals *can* include:
- message volume  
- general access patterns  
- anonymous heartbeat events  
- uptime or liveness metrics  
- non-identifying metadata  
- any signal that implies “something is alive here”  

### Signals *never* include:
- usernames  
- GPS coordinates  
- IP addresses  
- device IDs  
...
Infrared is strictly **aggregate-in, aggregate-out**.
...
- **Warmth Index graphs** (life presence over time)  
- **Collapse Alerts** (sharp declines)  
- **Stability Metrics** (variance and continuity)  
- **Disappearance Detection** (life signals vanishing)  
- **Recovery Patterns** (life returning after disruption)  

Infrared is intentionally compatible with:
